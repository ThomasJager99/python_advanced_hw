from sqlalchemy import create_engine, BigInteger, Column, String, SmallInteger, Boolean
...
BASE_DIR = Path(__file__).parent #or parents[0-5] - if you have long path
print(__file__)
print(BASE_DIR)
...
class User(Base):
    ...
    ia_active: Mapped[bool] = mapped_column(
        Boolean,
        default=True
    )
